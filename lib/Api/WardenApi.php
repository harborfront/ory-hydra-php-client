...
class WardenApi
{
    ...
    /**
     * Operation wardenAllowed
     *
     * Check if a subject is allowed to do something
     *
     * @param \Ory\Hydra\Model\AllowedRequest $body  (optional)
     * @throws \Ory\Hydra\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Hydra\Model\InlineResponse2002
     */
    public function wardenAllowed($body = null)
    {
        list($response) = $this->wardenAllowedWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation wardenAllowedWithHttpInfo
     *
     * Check if a subject is allowed to do something
     *
     * @param \Ory\Hydra\Model\AllowedRequest $body  (optional)
     * @throws \Ory\Hydra\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Hydra\Model\InlineResponse2002, HTTP status code, HTTP response headers (array of strings)
     */
    public function wardenAllowedWithHttpInfo($body = null)
    {
        $returnType = '\Ory\Hydra\Model\InlineResponse2002';
        $request = $this->wardenAllowedRequest($body);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Ory\Hydra\Model\InlineResponse2002', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Ory\Hydra\Model\InlineResponse401', $e->getResponseHeaders());
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function wardenAllowedAsync($body = null)
    {
        return $this->wardenAllowedAsyncWithHttpInfo($body)->then(function ($response) {
            return $response[0];
        });
    }

    /**
     * Operation wardenAllowedAsyncWithHttpInfo
     *
     * Check if a subject is allowed to do something
     *
     * @param \Ory\Hydra\Model\AllowedRequest $body  (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function wardenAllowedAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Ory\Hydra\Model\InlineResponse2002';
        $request = $this->wardenAllowedRequest($body);
    ...
    /**
     * Create request for operation 'wardenAllowed'
     *
     * @param \Ory\Hydra\Model\AllowedRequest $body  (optional)
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function wardenAllowedRequest($body = null)
    {
    ...
    /**
     * Operation wardenTokenAllowed
     *
     * Check if the subject of a token is allowed to do something
     *
     * @param \Ory\Hydra\Model\WardenTokenAllowedBody $body  (optional)
     * @throws \Ory\Hydra\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Hydra\Model\InlineResponse2003
     */
    public function wardenTokenAllowed($body = null)
    {
        list($response) = $this->wardenTokenAllowedWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation wardenTokenAllowedWithHttpInfo
     *
     * Check if the subject of a token is allowed to do something
     *
     * @param \Ory\Hydra\Model\WardenTokenAllowedBody $body  (optional)
     * @throws \Ory\Hydra\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Hydra\Model\InlineResponse2003, HTTP status code, HTTP response headers (array of strings)
     */
    public function wardenTokenAllowedWithHttpInfo($body = null)
    {
        $returnType = '\Ory\Hydra\Model\InlineResponse2003';
        $request = $this->wardenTokenAllowedRequest($body);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Ory\Hydra\Model\InlineResponse2003', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Ory\Hydra\Model\InlineResponse401', $e->getResponseHeaders());
    ...
    /**
     * Operation wardenTokenAllowedAsync
     *
     * Check if the subject of a token is allowed to do something
     *
     * @param \Ory\Hydra\Model\WardenTokenAllowedBody $body  (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function wardenTokenAllowedAsync($body = null)
    {
        return $this->wardenTokenAllowedAsyncWithHttpInfo($body)->then(function ($response) {
            return $response[0];
        });
    }

    /**
     * Operation wardenTokenAllowedAsyncWithHttpInfo
     *
     * Check if the subject of a token is allowed to do something
     *
     * @param \Ory\Hydra\Model\WardenTokenAllowedBody $body  (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function wardenTokenAllowedAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Ory\Hydra\Model\InlineResponse2003';
        $request = $this->wardenTokenAllowedRequest($body);
    ...
    /**
     * Create request for operation 'wardenTokenAllowed'
     *
     * @param \Ory\Hydra\Model\WardenTokenAllowedBody $body  (optional)
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function wardenTokenAllowedRequest($body = null)
    {
