...
class Oauth2Api
{
     ...
     * @throws \Ory\Hydra\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Hydra\Model\InlineResponse200
     */
    public function introspectOAuthToken()
    {
        list($response) = $this->introspectOAuthTokenWithHttpInfo();
        return $response;
    }
     ...
     * @throws \Ory\Hydra\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Hydra\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function introspectOAuthTokenWithHttpInfo()
    {
        $returnType = '\Ory\Hydra\Model\InlineResponse200';
        $request = $this->introspectOAuthTokenRequest();
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Ory\Hydra\Model\InlineResponse200', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Ory\Hydra\Model\InlineResponse401', $e->getResponseHeaders());
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function introspectOAuthTokenAsync()
    {
        return $this->introspectOAuthTokenAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function introspectOAuthTokenAsyncWithHttpInfo()
    {
        $returnType = '\Ory\Hydra\Model\InlineResponse200';
        $request = $this->introspectOAuthTokenRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function introspectOAuthTokenRequest()
    {
    ...
    {
        return $this->oauthAuthAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
     ...
     * @throws \Ory\Hydra\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ory\Hydra\Model\InlineResponse2001
     */
     ...
     * @throws \Ory\Hydra\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ory\Hydra\Model\InlineResponse2001, HTTP status code, HTTP response headers (array of strings)
     */
    public function oauthTokenWithHttpInfo()
    {
        $returnType = '\Ory\Hydra\Model\InlineResponse2001';
        $request = $this->oauthTokenRequest();
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Ory\Hydra\Model\InlineResponse2001', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\Ory\Hydra\Model\InlineResponse401', $e->getResponseHeaders());
    ...
    {
        return $this->oauthTokenAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function oauthTokenRequest()
    {
     ...
     *
     * @param \Ory\Hydra\Model\Body $body  (required)
     * @throws \Ory\Hydra\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function revokeOAuthToken($body)
    {
        $this->revokeOAuthTokenWithHttpInfo($body);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function revokeOAuthTokenWithHttpInfo($body)
    {
        $returnType = '';
        $request = $this->revokeOAuthTokenRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revokeOAuthTokenAsync($body)
    {
        return $this->revokeOAuthTokenAsyncWithHttpInfo($body)->then(function ($response) {
            return $response[0];
        });
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revokeOAuthTokenAsyncWithHttpInfo($body)
    {
        $returnType = '';
        $request = $this->revokeOAuthTokenRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function revokeOAuthTokenRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling revokeOAuthToken');
        }
